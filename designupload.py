...
def main():
    st.title("📦 Gildan 64000 Printify Uploader (Pick Provider)")
    ...
    # --- Fetch available providers for blueprint ---
    try:
    ...
    try:
        ...
        enabled_variant_ids = [v["id"] for v in variants_data if v.get("enabled") and v["id"] in SIZE_MAP]
